                    ...
                    <td>
                        ...
                        @if(!empty($module['version']['installed_version']))
                            <small class="label bg-gray">
                                @lang('lang_v1.version') {{ $module['version']['installed_version'] }}
                            </small>
                        @endif
                    
                        @if(!empty($module['version']['is_update_available']) && !empty($module['update_link']))
                            <div class="alert alert-warning mt-5">
                                <i class="fas fa-sync"></i>
                                @lang('lang_v1.module_new_version', [
                                    'module' => $module['name'] ?? '',
                                    'link' => $module['update_link'] ?? '#'
                                ])
                            </div>
                        @endif
                    </td>
