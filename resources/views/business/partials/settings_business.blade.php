<div class="pos-tab-content active">
    ...
    <div class="row hide">
        <div class="col-sm-8">
            ...
            <div class="form-group">
                <label>
                    {!! Form::checkbox('enable_whatsapp_module', 1, !empty($settings['enable_whatsapp_module']), ['class' => 'input-icheck']) !!}
                    Notifications WhatsApp
                    @show_tooltip('Activer le module de notifications automatiques via WhatsApp')
                </label>
            </div>
