...
return [
    'delete_enowledge_base' => 'supprimée la base de connaissances',
    'edit_enowledge_base' => 'modifier la base de connaissances',
    'access_sales_target' => 'accès cible de vente',
    'view_message' => 'afficher le message',
    'create_message' => 'creer un message',
    'delete_todos' => 'supprimée tout',
    'edit_todos' => 'modifier tout',
    'add_todos' => 'ajouter tout',
    'delete_payroll' => 'supprimée la paie',
    'view_all_payroll' => 'voir tout les paiements',
    'type_message' => 'contenu du message',
    'messages' => 'messages',
    'essentials_module' => 'Module Essentiel',
    'calculate_sales_target_commission_without_tax_help' => "calculer l'objectif de vente commission hors taxe aide",
    'calculate_sales_target_commission_without_tax' => "calculer l'obejectif de vente commission sans taxe",
    'payroll_cant_be_deleted_if_final' => 'La paie ne peut pas être supprimée si elle est définitive.',
    'total_sales_amount_to' => 'montant total des ventes à',
    'total_sales_amount_from' => 'montant total des ventes provenant de',
    'set_sales_target' => "définir l'objectif de vente",
    'set_sales_target_for' => "définir l'objectif de ventes pour",
    'sales_target' => 'objectif de vente',
    'sales_targets' => 'objectifs de vente',
    'commission_percent' => 'commission pourcentage',
    'targets' => 'cibles',
    'target_achieved_this_month' => 'objectif atteint ce mois',
    'target_achieved_last_month' => 'cible atteinte le mois dernier',
    'my_sales_targets' => 'Mes objectifs de ventes',
    ...
    'max_leave_count' => 'Nombre maximum de congés',
