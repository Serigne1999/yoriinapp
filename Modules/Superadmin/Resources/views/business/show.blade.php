...
@section('content')
    ...
    <section class="content-header">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('superadmin::lang.view_business')
            <small class="tw-text-sm md:tw-text-base tw-text-gray-700 tw-font-semibold"> {{ $business?->name ?? 'N/A' }} </small>
        </h1>
        <!-- <ol class="breadcrumb">
                        ...
                        <div class="tw-inline-block tw-min-w-full tw-py-2 tw-align-middle sm:tw-px-5">
                            <div class="col-sm-3">
                                <div class="well well-sm">
                                    ...
                                    <p class="text-muted">
                                        {{ $business?->currency?->currency ?? 'N/A' }}
                                    </p>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @foreach ($business?->subscriptions ?? [] as $subscription)
                                        <tr>
                                            <td>{{ $subscription->package_details['name'] ?? 'N/A' }}</td>
                                            <td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            var users_table = $('#users_table').DataTable({
                ...
                serverSide: true,
                fixedHeader:false,
                ajax: '/superadmin/users/' + "{{ $business?->id ?? 0 }}",
                columnDefs: [{
                    "targets": [4],
                    "orderable": false,
                    "searchable": false
