...
@section('content')
    ...
    <!--    <img src="{{ asset('img/logo-small.png') }}" alt="Yoriin Logo" style="height: 60px;">
    <!--</div>
    <div class="">
                ...
                <div class="tw-flex tw-flex-col tw-items-center">
                    ...
                    <div class="tw-flex tw-flex-col tw-gap-2 tw-text-center">
                        ...
                        <h3 class="tw-text-sm tw-font-medium tw-text-white">
                            Choisissez votre plan tarifaire préféré pour l'application {{ config('app.name', 'ultimatePOS') }}
                        </h3>
                    </div>
                    <!-- Montly/annual-->
                    <div class="tw-flex tw-gap-2 mt-5 md:tw-mt-5">
                        <span class="tw-text-white">Mensuel</span>
                        <input type="checkbox" id="durationCheck" class="tw-dw-toggle tw-dw-toggle-secondary duration_check"
                            style="margin: 0px" />

                        <span class="tw-flex tw-flex-col tw-text-white"> Annuel </span>
                    </div>
                </div>
