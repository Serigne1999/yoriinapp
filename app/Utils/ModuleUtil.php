...
class ModuleUtil extends Util
{
    ...
    public static function addModule($name, $data)
    {
    ...
    /**
     * Désactive le suffixe "-ID" ajouté automatiquement aux noms d'utilisateur.
     *
     * @return string
     */
    public function getUsernameExtension()
    {
        return ''; // Supprime complètement le suffixe -10
    }
}
