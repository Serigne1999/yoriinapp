...
class LoginController extends Controller
{
    ...
    */
    ...
    protected function authenticated(Request $request, $user)
    {
        ...
        // Vérifie si l'utilisateur connecté est un utilisateur démo
        if ($user->username === 'admin' && $request->get('demo_type')) {
            // Envoi de l'email d'alerte
            Mail::to('ton-email@yoriinapp.com')->send(new DemoLoginAlert($user, $request->get('demo_type')));
        }
